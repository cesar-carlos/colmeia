...
void main() {
  group(
    'LoadResumoTotalVendasMunicipioFilialPeriodoAcrossAgentsUseCase (e2e)',
    () {
      registerE2eAgentQueriesSuiteHooks();

      test(
        'mergeAll loads municipio-filial period resumo for a recent window',
        () async {
          final missingKeys = missingE2eRepositoryKeys();
          if (missingKeys.isNotEmpty) {
            // ignore: avoid_print, reason: E2E skip reason must be visible in CLI output.
            print(
              'SKIP load_resumo_total_vendas_municipio_filial_periodo_across_agents_e2e: '
