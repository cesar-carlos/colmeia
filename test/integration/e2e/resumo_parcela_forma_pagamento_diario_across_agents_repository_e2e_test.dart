...
void main() {
  group(
    'LoadResumoParcelaFormaPagamentoDiarioAcrossAgentsUseCase (e2e)',
    () {
      registerE2eAgentQueriesSuiteHooks();

      test(
        'mergeAll loads daily payment-method resumo for a known sale window',
        () async {
          if (skipE2eWhenMissingRepositoryKeys(
            'resumo_parcela_forma_pagamento_diario_across_agents_repository_e2e',
          )) {
            return;
          }
