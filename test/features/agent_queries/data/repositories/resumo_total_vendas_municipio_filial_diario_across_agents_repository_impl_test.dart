...
class _MockLoadResumo extends Mock
    implements LoadResumoTotalVendasMunicipioFilialDiarioUseCase {}

void main() {
  late _MockTargetResolver targetResolver;
  late _MockPlanBuilder planBuilder;
  late AgentQueryExecutor<ResumoTotalVendasMunicipioFilialDiarioRow> executor;
  late _MockLoadResumo loadResumo;
  late ResumoTotalVendasMunicipioFilialDiarioAcrossAgentsRepositoryImpl
  repository;
  ...
  setUpAll(() {
    ...
    registerFallbackValue(AgentQueryKey.resumoTotalVendasMunicipioFilialDiario);
  ...
  setUp(() {
    ...
    executor = AgentQueryExecutor<ResumoTotalVendasMunicipioFilialDiarioRow>();
