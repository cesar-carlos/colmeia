...
void main() {
  ...
  late AgentQueryExecutor<ResumoParcelasDiaSemanaRow> executor;
  late _MockLoadResumo loadResumo;
  late ResumoParcelasDiaSemanaAcrossAgentsRepositoryImpl repository;
  ...
  setUp(() {
    ...
    executor = AgentQueryExecutor<ResumoParcelasDiaSemanaRow>();
    loadResumo = _MockLoadResumo();
    repository = ResumoParcelasDiaSemanaAcrossAgentsRepositoryImpl(
  ...
  test(
    ...
    () async {
      ...
      when(
        ...
        (_) async =>
            const Failure<List<ResumoParcelasDiaSemanaRow>, AppFailure>(
