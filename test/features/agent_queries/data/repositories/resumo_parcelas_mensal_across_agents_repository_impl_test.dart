...
class _MockLoadResumo extends Mock implements LoadResumoParcelasMensalUseCase {}

void main() {
  late _MockTargetResolver targetResolver;
  late _MockPlanBuilder planBuilder;
  late AgentQueryExecutor<ResumoParcelasMensalRow> executor;
  late _MockLoadResumo loadResumo;
  late ResumoParcelasMensalAcrossAgentsRepositoryImpl repository;
  ...
  setUpAll(() {
    ...
    registerFallbackValue(AgentQueryKey.resumoParcelasMensal);
  ...
  setUp(() {
    ...
    executor = AgentQueryExecutor<ResumoParcelasMensalRow>();
    loadResumo = _MockLoadResumo();
    repository = ResumoParcelasMensalAcrossAgentsRepositoryImpl(
  ...
  test(
    ...
    () async {
      ...
      when(
        ...
        (_) async => const Failure<List<ResumoParcelasMensalRow>, AppFailure>(
