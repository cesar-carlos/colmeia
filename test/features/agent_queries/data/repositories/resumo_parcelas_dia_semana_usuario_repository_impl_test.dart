...
void main() {
  ...
  late ResumoParcelasDiaSemanaUsuarioRepositoryImpl repository;
  ...
  setUp(() {
    ...
    repository = ResumoParcelasDiaSemanaUsuarioRepositoryImpl(
  ...
  test('builds request and maps rows for the report query', () async {
    ...
    check(rows.single.nomeUsuario).equals('Bruna');
    ...
    check(capturedRequest.executeOptions!.maxRows).equals(5000);
    ...
    check(capturedRequest.sql).contains('ResumoParcelasDiaSemanaUsuario');
