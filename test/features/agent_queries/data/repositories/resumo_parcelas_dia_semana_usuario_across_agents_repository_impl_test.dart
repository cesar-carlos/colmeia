...
class _MockLoadResumo extends Mock
    implements LoadResumoParcelasDiaSemanaUsuarioUseCase {}

void main() {
  late _MockTargetResolver targetResolver;
  late _MockPlanBuilder planBuilder;
  late AgentQueryExecutor<ResumoParcelasDiaSemanaUsuarioRow> executor;
  late _MockLoadResumo loadResumo;
  late ResumoParcelasDiaSemanaUsuarioAcrossAgentsRepositoryImpl repository;
  ...
  setUpAll(() {
    ...
    registerFallbackValue(AgentQueryKey.resumoParcelasDiaSemanaUsuario);
  ...
  setUp(() {
    ...
    executor = AgentQueryExecutor<ResumoParcelasDiaSemanaUsuarioRow>();
    loadResumo = _MockLoadResumo();
    repository = ResumoParcelasDiaSemanaUsuarioAcrossAgentsRepositoryImpl(
  ...
  test(
    ...
    () async {
      ...
      when(
        ...
        (_) async =>
            const Success<List<ResumoParcelasDiaSemanaUsuarioRow>, AppFailure>(
  ...
  test(
    ...
    () async {
      ...
      when(
        ...
        (_) async =>
            const Failure<List<ResumoParcelasDiaSemanaUsuarioRow>, AppFailure>(
