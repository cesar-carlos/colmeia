...
void main() {
  ...
  late LoadResumoParcelasDiaSemanaUsuarioUseCase useCase;
  ...
  setUp(() {
    ...
    useCase = LoadResumoParcelasDiaSemanaUsuarioUseCase(repository);
  });

  test('forwards arguments to the repository', () async {
    final expectedRows = <ResumoParcelasDiaSemanaUsuarioRow>[
    ...
    when(
      ...
      (_) async => Success<List<ResumoParcelasDiaSemanaUsuarioRow>, AppFailure>(
        expectedRows,
      ),
    );
