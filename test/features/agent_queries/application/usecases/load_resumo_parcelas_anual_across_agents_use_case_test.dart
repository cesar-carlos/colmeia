...
void main() {
  ...
  late LoadResumoParcelasAnualAcrossAgentsUseCase useCase;
  ...
  setUp(() {
    ...
    useCase = LoadResumoParcelasAnualAcrossAgentsUseCase(repository);
  });

  test('should forward arguments to the repository', () async {
    const expectedReport = AgentQueryExecutionReport<ResumoParcelasAnualRow>(
