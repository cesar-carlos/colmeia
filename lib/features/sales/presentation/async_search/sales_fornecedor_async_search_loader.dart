...
AppAsyncSearchLoader<int> createSalesFornecedorAsyncSearchLoader({
  required LoadFornecedorOptionsUseCase useCase,
  ...
  return (AppAsyncSearchQuery query) async {
    ...
    final result = await useCase(
      userId: userId,
      agentId: agentId,
      filter: FornecedorOptionsFilter(
