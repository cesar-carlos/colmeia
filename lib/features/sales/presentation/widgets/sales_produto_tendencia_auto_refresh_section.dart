...
class SalesProdutoTendenciaAutoRefreshSection extends StatelessWidget {
  const SalesProdutoTendenciaAutoRefreshSection({
...
@immutable
class _SalesProdutoTendenciaAutoRefreshSlice {
  const _SalesProdutoTendenciaAutoRefreshSlice({
    required this.canScheduleAutoRefresh,
  });

  factory _SalesProdutoTendenciaAutoRefreshSlice.from(
    SalesProdutoTendenciaPresentationState state,
  ) {
    return _SalesProdutoTendenciaAutoRefreshSlice(
  ...
  bool operator ==(Object other) {
    return other is _SalesProdutoTendenciaAutoRefreshSlice &&
