...
class OverviewAiInsightCard extends StatelessWidget {
  const OverviewAiInsightCard({
    required this.insight,
    this.onApply,
    super.key,
  });

  final OverviewAiInsight insight;
  ...
  Widget build(BuildContext context) {
    ...
    return AppEditorialMediaCard(
      ...
      hero: _OverviewAiInsightArtwork(
...
class _OverviewAiInsightArtwork extends StatelessWidget {
  const _OverviewAiInsightArtwork({
