...
class LoadResumoParcelasDiaSemanaUsuarioAcrossAgentsUseCase {
  LoadResumoParcelasDiaSemanaUsuarioAcrossAgentsUseCase(this._repository);

  final ResumoParcelasDiaSemanaUsuarioAcrossAgentsRepository _repository;
