/// Filters and pagination for the fornecedor catalog `sql.execute` query.
class FornecedorOptionsFilter {
  ...
  /// Must stay <= `AgentQueriesBoundedResultMaxRows.fornecedorOptionsPage`.
